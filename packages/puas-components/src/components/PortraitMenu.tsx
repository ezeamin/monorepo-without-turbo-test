...
// import MenuModuleButton from '@/components/ui/MenuModuleButton';
...
//               <AccountButton />
//               {/* Boton para el Tema */}
//               <ThemeTogglerButton className="bg-sky-100 dark:bg-neutral duration-500 flex gap-x-4 items-center mb-5 px-4 rounded shadow text-center" />
